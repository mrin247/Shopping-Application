...
// ! This controller handles page/create route and connects create page button in admin app to create page
...
// ! This controller handles page/:category/:type routue to get page url
